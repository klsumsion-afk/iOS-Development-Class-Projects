...
let shortRun = RunningWorkout(distance: 5.0, time: 10.1)
let longSwim = SwimmingWorkout(distance: 100.5, time: 12_345)
simpleWorkoutDescription(workout: shortRun)
simpleWorkoutDescription(workout: longSwim)
/*:
