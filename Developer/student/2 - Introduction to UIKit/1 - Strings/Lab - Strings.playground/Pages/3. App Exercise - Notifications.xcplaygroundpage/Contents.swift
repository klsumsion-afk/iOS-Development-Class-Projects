 ...
 */
let firstName = "Kermit"
let lastName = "The Frog"
...
let newBest = 15125
print("Congratulations, \(fullName)! You beat you previous daily high score of \(previousBest) steps by walking \(newBest) steps yesterday!")
/*:
