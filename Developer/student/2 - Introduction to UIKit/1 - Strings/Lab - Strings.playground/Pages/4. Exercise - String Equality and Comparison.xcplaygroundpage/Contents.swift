 ...
 */
let nameInCaps = "Karigan Sumsion"
let name = "karigan sumsion"
if nameInCaps == name {
...
} else if nameInCaps.lowercased() != name.lowercased(){print("\(nameInCaps.lowercased()) and \(name.lowercased()) are not the same.")}
...
if junior.contains("Jr."){print("We found a second generation name!")
}
