 ...
 */
let favoriteQuote = "fair is where you go for cotton candy"
...
let emptyString = "j"
if emptyString == "" {print("There's nothing here")
} else if emptyString != "" {print("It's not as empty as I thought")}
