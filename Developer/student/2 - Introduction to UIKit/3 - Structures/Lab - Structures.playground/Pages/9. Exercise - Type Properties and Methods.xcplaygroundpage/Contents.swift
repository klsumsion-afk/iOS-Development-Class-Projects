...
let currentUser = User(userName: "Karigan", email: "klsumsion@gmail.com", age: 20)
print(currentUser)
/*:
 ...
 */
let currentUser2 = User(userName: "Kuzco", email: "BadLlama@gmail.com", age: 21)
User.logIn(currentUser2)
print(User.logIn(currentUser2))
