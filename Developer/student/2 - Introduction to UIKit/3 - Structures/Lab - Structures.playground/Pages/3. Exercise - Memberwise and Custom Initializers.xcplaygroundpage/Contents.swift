...
let favoriteBook = Book(title: "Wyvernspell", author: "Sam Bragg", pages: 22, price: 0.0)
print(favoriteBook)
/*:
...
let firstLaptop = Laptop(yearPurchased: 2023)
let secondLaptop = Laptop(screenSize: 15,yearPurchased: 2025)
print(firstLaptop, secondLaptop)
/*:
...
struct Height {
    ...
    init(heightInInches2: Double) {
        ...
        heightInCentimeters = heightInInches2 * 2.54
    }
...
let currentHeight = Height(heightInInches2: 5.5)
let otherHeight = Height(heightInCentimeters: 510.5)
...
var myHeight = Height(heightInInches2: 64)
print(myHeight)
/*:
