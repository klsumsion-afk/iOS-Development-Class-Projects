...
var karigan = User(name: "Karigan", age: 20, height: 5.5, weight: 136, activityLevel: 1)
print(karigan)
/*:
...
var mile = Distance(meters2: 1600)
print(mile)

//:  Now create another instance of `Distance` and give it some other distance. Ensure that both properties are set correctly.
var myDistance = Distance(meters2: 1610)
print(myDistance)
/*:
