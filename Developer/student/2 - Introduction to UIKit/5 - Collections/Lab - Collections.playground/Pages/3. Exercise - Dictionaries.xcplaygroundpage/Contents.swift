 ...
 */
var dayInMonth = ["January": 31, "February": 28, "March": 31]
print(dayInMonth)
...
if let january = dayInMonth["January"] {
    print("January has 31 days")
}

//:  Given the following arrays, create a new [String : [String]] dictionary. `shapesArray` should use the key "Shapes" and `colorsArray` should use the key "Colors." Print the resulting dictionary.
var shapesArray: [String: [String]] = [
    "Shapes": ["square", "rectangle", "triangle", "circle", "diamond"],
    "3D Shapes": ["cube", "pyramid", "cylinder", "sphere"]
]
...
if let colors = colorsArray["Colors"] {
    print(colors)
}
