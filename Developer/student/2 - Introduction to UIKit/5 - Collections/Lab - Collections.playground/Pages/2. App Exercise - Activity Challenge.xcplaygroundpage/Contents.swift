 ...
 */
var walkingChallenges = ["Walk 4 miles a week","Walk 1 mile a day", "Walk 2 miles a day", "Walk 20 miles a week"]
var runningChallenges: [String] = ["Run 1 lap a day", "Run 1 mile a day", "Run 5 miles a day", "Run 20 miles a week"]
...
var challengesCommittedTo: [String] = [ ]

//:  Write an if statement that will use `isEmpty` to check if there is anything in the array. If there is not, print a statement asking the user to commit to a challenge. Add an else-if statement that will print "The challenge you have chosen is <INSERT CHOSEN CHALLENGE>" if the array count is exactly 1. Then add an else statement that will print "You have chosen multiple challenges."
if challengesCommittedTo.isEmpty {
    print("Please select a challenge to commit to before proceeding.")
} else if challengesCommittedTo.contains(challengesCommittedTo[0]) {
    print("The challenge you have chosen is \(challengesCommittedTo)")
} else {
