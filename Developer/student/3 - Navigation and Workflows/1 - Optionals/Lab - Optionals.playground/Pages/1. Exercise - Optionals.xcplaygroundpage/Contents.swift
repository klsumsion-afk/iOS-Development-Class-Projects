 ...
 */
let userInputAge: String = "30"
let userAge: Int? = Int(userInputAge)
//The error you receive is the value of type Int? needs to be unwrapped to a value of type int.
...
//print(userAge)
// It is nil because userInputAge is written not as a string.
/*:
