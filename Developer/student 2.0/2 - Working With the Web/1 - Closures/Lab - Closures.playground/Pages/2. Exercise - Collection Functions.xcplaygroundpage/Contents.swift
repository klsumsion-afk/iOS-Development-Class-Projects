...
let myForwards = forwards(name1: "Atty", name2: "Babby")
print(myForwards)
...
let lovedOnes = ["Mom", "Dad", "Amber", "Kelli", "Cameron", "Tab", "Eric", "Ben", "NaVia", "Emma", "Clem"]

let sortedLovedOnes = lovedOnes.sorted(by: forwards)
let sortedCollection1 = sortedLovedOnes
...
let sortedLovedOnesAgain = lovedOnes.sorted { (name1, name2) -> Bool in
    return name1 < name2
}
let sortedCollection2 = sortedLovedOnesAgain
print(sortedLovedOnesAgain)
...
let sortedLovedOnesAgainAgain = lovedOnes.sorted(by: <)
let sortedCollection3 = sortedLovedOnesAgainAgain
